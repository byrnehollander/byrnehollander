...
# Introduction
{% marginnote margin1 %} 
{% image /assets/images/tracing.png 400 530 raw %}
...
I now, as Deleuze and Guattari do in the introduction to *A Thousand Plateaus* describe the three major botanical figures: the Tree, the Root, and the Rhizome. But before I do, want a brief aside about the metaphor.
...
{% image /assets/images/facebook-relationships.jpg 2000 1000 %}
